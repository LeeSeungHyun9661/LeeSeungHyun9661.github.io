/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+css-extras+java&plugins=line-highlight+line-numbers+show-language+toolbar+copy-to-clipboard */
var _self =
         ...
         a = {
            ...
            highlightElement: function (n, t, r) {
               ...
               if (
                  ...
                  return (
                     a.hooks.run("complete", s), void (r && r.call(s.element))
                  );
                  ...
                  for (
                     ...
                     if (!(E instanceof i)) {
                        ...
                        if (y) {
                           ...
                           if (
                              ((A = j -= w.value.length), w.value instanceof i)
                           )
                              continue;
                           for (
                              var C = w;
            ...
            h.forEach(function (e) {
               ...
               if (!((n = Math.min(b + d, n)) < i)) {
                  ...
                  if (
                     ...
                     if (l) {
                        var u =
                           l.offsetTop - s.offsetTop + l.offsetHeight + "px";
                        v.push(function () {
                           r.style.height = u;
                        });
                     }
